...
void Map::build()
{
	...
	for (int y_coord = 0; y_coord < m_height; y_coord++)
	{
		...
		for (int x_coord = 0; x_coord < m_width; x_coord++)
		{
			...
			// store updated / calculated vertices and textures 
	...
	// MAKE SURE TO UPDATE BOUNDS IF SIZE OF TILES CHANGES
